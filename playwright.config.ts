...
const webServerEnv = {
    ...
    PRINTER_QUEUE_POLL_SECONDS: process.env.PRINTER_QUEUE_POLL_SECONDS ?? "1",
    ...
    DASHBOARD_REALTIME_REFRESH_MS: process.env.DASHBOARD_REALTIME_REFRESH_MS ?? "1000",
    ...
    webServer: [
        {
            command: [
                ...
                `PRINTER_QUEUE_POLL_SECONDS=${webServerEnv.PRINTER_QUEUE_POLL_SECONDS}`,
                ...
                `DASHBOARD_REALTIME_REFRESH_MS=${webServerEnv.DASHBOARD_REALTIME_REFRESH_MS}`,
