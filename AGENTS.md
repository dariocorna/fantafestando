...
- **Commit**: Realizzare sempre commit piccoli, frequenti e atomici, seguendo lo stile Agile (es. `feat:`, `fix:`, `docs:`, `chore:`). Ogni commit deve contenere un'unica modifica logica. **I messaggi di commit devono essere scritti in lingua inglese.**
