            ...
            <div className="mx-auto max-w-6xl px-4 py-6 md:px-6 md:py-10">
                <div className="mx-auto max-w-5xl">
                    <div className="mb-6 rounded-[28px] border border-[#d9e6f8] bg-white/80 px-4 py-3 text-sm font-semibold text-[var(--brand-blue-700)] shadow-[var(--brand-shadow-soft)] backdrop-blur">
                        Preview UI issue #57: proposta schermata &quot;ordine effettuato&quot; con riepilogo sempre visibile e blocco foto opzionale integrato.
                    </div>
                        ...
                        {showPhotoOption ? (
                            <section id="menu-success-preview-photo" className="scroll-mt-6 space-y-4">
                                ...
                                <EasterEggComposer
                                    ...
                                    description="Preview del blocco opzionale dentro la nuova schermata di conferma ordine."
